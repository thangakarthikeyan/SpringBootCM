...
public class TaxIdType  {
  ...
  private String taxIdTypeCode = null;
  ...
  **/
  ...
  public TaxIdType taxIdTypeCode(String taxIdTypeCode) {
    this.taxIdTypeCode = taxIdTypeCode;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxIdType {\n");
    
    sb.append("    taxIdTypeCode: ").append(toIndentedString(taxIdTypeCode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
